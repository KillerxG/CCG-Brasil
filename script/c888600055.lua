...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--(1)"Dream Kingdom" monsters cannot be destroyed by opponent's effect
	...
	c:RegisterEffect(e2)
	--(2)"Dream Kingdom" monsters cannot be targeted by opponent's effect
	local e3=e2:Clone()
...
function s.cfilter(e,c)
	return c:IsFaceup() and c:IsSetCard(0x690)
end
--(3)Shuffle and draw
function s.tdfilter(c,e)
	return c:IsSetCard(0x690) and c:IsMonster() and c:IsAbleToDeck() and c:IsCanBeEffectTarget(e)
end
