...
function s.thfilter(c)
	return c:IsRitualSpell() and c:IsSetCard(0x275) and c:IsAbleToHand()
end
...
function s.tkcheck(e,tp)
	return Duel.IsPlayerCanSpecialSummonMonster(tp,id+5,0,TYPES_TOKEN,1400,3,2,RACE_FIEND,ATTRIBUTE_DARK)
end
