...
function s.initial_effect(c)
	...
	--(2)Bottom of the Deck or Special Summon it
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		local tc=g:GetFirst()
		if e:GetLabel()==1 and (tc:IsCanBeSpecialSummoned(e,0,tp,false,false) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0) and (not Duel.SelectYesNo(tp,aux.Stringid(id,1))) then
