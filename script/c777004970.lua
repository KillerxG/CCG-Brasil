...
function s.actcon(e)
    ...
    local is_battle_phase = (ph >= PHASE_BATTLE_START and ph <= PHASE_BATTLE)
    return is_battle_phase and Duel.IsExistingMatchingCard(s.bossfilter, tp, LOCATION_MZONE, 0, 1, nil)
end
--(2)Send random card from hand to GY
