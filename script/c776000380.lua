...
function s.aclimit(e,re)
	...
	or re:GetHandler():IsSetCard(0x300) or re:GetHandler():IsSetCard(0x301) or re:GetHandler():IsSetCard(0x302)
	or re:GetHandler():IsSetCard(0x304) or re:GetHandler():IsSetCard(0x305) or re:GetHandler():IsSetCard(0x306)
	or re:GetHandler():IsSetCard(0x307) or re:GetHandler():IsSetCard(0x308) or re:GetHandler():IsSetCard(0x309)
	or re:GetHandler():IsSetCard(0x310) or re:GetHandler():IsSetCard(0x311) or re:GetHandler():IsSetCard(0x312)
	or re:GetHandler():IsSetCard(0x311b) or re:GetHandler():IsSetCard(0x313))
end
