...
function s.tgfilter(c)
	return c:IsAbleToGrave() and c:IsSetCard(0x444)
end
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.tgfilter,tp,LOCATION_REMOVED,0,1,2,e:GetHandler())
	if #g>0 then
