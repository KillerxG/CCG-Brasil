...
s.material={777000770}
s.listed_names={777000770}
--Synchro Summon
function s.tunerfilter(c,lc,stype,tp)
	return c:IsSummonCode(lc,stype,tp,777000770)
end
--(1)Return to hand
function s.thfilter(c,e,tp)
	return (c:IsControler(tp) or c:IsControler(1-tp)) and c:IsAbleToHand() and c:IsCanBeEffectTarget(e)
end
