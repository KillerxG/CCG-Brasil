...
-- Filtro para identificar as cartas Rockslash (0x309) e Idrakian (0x313)
function s.restrict_filter(c)
    return c:IsSetCard(0x309) or c:IsSetCard(0x313)
end
...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
    ...
    -- "If you do not have a "Rockslash" or "Idrakian" card in your hand, field, GY or banishment:"
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    -- SUBSTITUA ESSES NÚMEROS PELOS IDs DAS SUAS 20 CARTAS Rockslash
    local main_deck_ids = {
        777002010, 777002010, 777002020, 777002090, 777002090,
        777002040, 777002040, 777001480, 777001480, 777002080,
        777002080, 777002080, 777002110, 777002110, 777002110,
        777002100, 777002150, 777002150, 777002170, 777002170
    }
    ...
    if Duel.SendtoGrave(hand, REASON_EFFECT) > 0 then
        ...
        -- "...then add 20 "Rockslash" cards outside of the Duel to your Deck"
