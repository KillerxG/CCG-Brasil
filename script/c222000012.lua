...
-- Filtro para identificar as cartas Oceanic Storm (0x312) e Idrakian (0x313)
function s.restrict_filter(c)
    return c:IsSetCard(0x312) or c:IsSetCard(0x313)
end
...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
    ...
    -- "If you do not have a "Oceanic Storm" or "Idrakian" card in your hand, field, GY or banishment:"
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    -- SUBSTITUA ESSES NÚMEROS PELOS IDs DAS SUAS 20 CARTAS Oceanic Storm
    local main_deck_ids = {
        777003320, 777003320, 777003280, 777003280, 777003380,
        777003380, 777003330, 777003330, 777003310, 777003310,
        777003340, 777003340, 777003340, 777003350, 777000830,
        777000830, 777000830, 777003290, 777003300, 777003300
    }
    ...
    if Duel.SendtoGrave(hand, REASON_EFFECT) > 0 then
        ...
        -- "...then add 20 "Oceanic Storm" cards outside of the Duel to your Deck"
