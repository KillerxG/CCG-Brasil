...
function s.initial_effect(c)	
	...
	e2:SetCondition(function(e,tp) return Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0 and aux.exccon(e) end)
...
function s.tgfilter(c)
	return c:IsLevel(5) and c:IsRace(RACE_WARRIOR) and c:IsAbleToGrave()
end
