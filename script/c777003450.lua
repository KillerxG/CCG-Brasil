...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
  ...
  and Duel.IsExistingMatchingCard(s.spxyzfilter,tp,LOCATION_HAND,0,1,nil,e,tp) end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
  ...
  local g1=Duel.SelectMatchingCard(tp,s.spxyzfilter,tp,LOCATION_HAND,0,1,1,nil,e,tp)
...
function s.spfilter2(c,e,tp,lv)
  return c:IsSetCard(0x998) and c:IsType(TYPE_MONSTER) and c:GetLevel()==lv and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
