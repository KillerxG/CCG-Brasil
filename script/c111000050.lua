...
function s.initial_effect(c)
	...
	c:RegisterEffect(e8)
	-- Efeito 1 (e9): Rolar 1 dado, monstros que você controla ganham ATK/DEF igual ao resultado x 200
    local e9 = Effect.CreateEffect(c)
    e9:SetDescription(aux.Stringid(id, 6))
    e9:SetCategory(CATEGORY_DICE | CATEGORY_ATKCHANGE | CATEGORY_DEFCHANGE)
    ...
    -- Efeito 2 (e10): Rolar 1 dado, monstros do oponente perdem ATK/DEF igual ao resultado x 200
    local e10 = Effect.CreateEffect(c)
    e10:SetDescription(aux.Stringid(id, 7))
    e10:SetCategory(CATEGORY_DICE | CATEGORY_ATKCHANGE | CATEGORY_DEFCHANGE)
    ...
    -- Efeito 3 (e11): "Amazement Abomination Arlekino" inafetado por efeitos de cartas
    local e11 = Effect.CreateEffect(c)
    e11:SetType(EFFECT_TYPE_FIELD)
    e11:SetCode(EFFECT_IMMUNE_EFFECT)
    e11:SetRange(LOCATION_FZONE)
    e11:SetTargetRange(LOCATION_MZONE, 0)
    e11:SetTarget(aux.TargetBoolFunction(Card.IsCode, 31600845))
    e11:SetValue(s.efilter)
    c:RegisterEffect(e11)

    -- Efeito 4 (e12): "Amazement Abomination Arlekino" pode atacar diretamente
    local e12 = Effect.CreateEffect(c)
    e12:SetType(EFFECT_TYPE_FIELD)
    e12:SetCode(EFFECT_DIRECT_ATTACK)
    e12:SetRange(LOCATION_FZONE)
    e12:SetTargetRange(LOCATION_MZONE, 0)
    e12:SetTarget(aux.TargetBoolFunction(Card.IsCode, 31600845))
    c:RegisterEffect(e12)
end
s.af="a"
s.tableAction = {
111000051,111000052,111000053,111000054,111000055, --Traps Custom
...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
		local token=Duel.CreateToken(tp,31600845)
		Duel.SpecialSummon(token,0,tp,tp,false,false,POS_FACEUP)
	end
end
-- ==========================================================
-- Efeito (e9): Rolar o Dado e Aumentar ATK/DEF (Aliados)
-- ==========================================================
...
function s.atkop(e, tp, eg, ep, ev, re, r, rp)
    ...
    -- Joga 1 dado de 6 lados e armazena o resultado para o ganho
...
-- ==========================================================
-- Efeito (e10): Rolar o Dado e Reduzir ATK/DEF (Oponentes)
-- ==========================================================
...
function s.defop(e, tp, eg, ep, ev, re, r, rp)
    ...
    -- Joga 1 dado de 6 lados e armazena o resultado para a perda (multiplicador negativo)
    local res = Duel.TossDice(tp, 1)
    local val = res * -200
...
-- ==========================================================
-- Efeitos (e11 e e12): Imunidade e Ataque Direto (Arlekino)
-- ==========================================================
