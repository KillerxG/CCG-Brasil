...
function s.matfilter(c,fc,sumtype,sump)
	return c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsRace(RACE_THUNDER,fc,sumtype,sump)
end
--(2)Aternative Special Summon procedure
...
function s.hspfilter(c,tp,sc)
	return c:IsRace(RACE_THUNDER) and c:IsAttribute(ATTRIBUTE_LIGHT) and not c:IsType(TYPE_FUSION,sc,MATERIAL_FUSION,tp) 
