...
--(1)Protection
function s.indcon(e)
	return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,777003510)
end
--(2)Special Summon
function s.spfilter(c,e,tp)
  return c:IsSetCard(0x998) and c:IsFaceup() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
