...
function s.initial_effect(c)
	...
	Xyz.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x353),9,2,nil,nil,Xyz.InfiniteMats)
	...
	--(1)Inflicts piercing battle damage
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_SINGLE)
	e1:SetCode(EFFECT_PIERCE)
	c:RegisterEffect(e1)
	--(2)Flip all opponent monsters face-down
...
function s.xyzfilter(c,e,tp)
  return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x353) and c:IsRank(11) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_XYZ,tp,false,false)
end
