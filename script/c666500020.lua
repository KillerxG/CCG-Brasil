...
function s.tgfilter(c)
	return c:IsSetCard(0x660) and (c:IsFaceup() or not c:IsLocation(LOCATION_MZONE)) and c:IsAbleToGrave()
end
...
function s.thfilter2(c)
	return c:IsAttribute(ATTRIBUTE_DARK) and c:IsSetCard(0x660) and c:IsMonster() and c:IsFaceup() and c:IsAbleToHand()
end
