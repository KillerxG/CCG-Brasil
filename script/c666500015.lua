...
function s.cfilter(c,tp)
	return c:IsLinked() and c:IsSetCard(0x660) and c:IsFaceup() and c:IsControler(tp)
end
function s.actcon(e)
...
function s.spfilter(c,e,tp,zone)
	return c:IsSetCard(0x660) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP,tp,zone)
end
