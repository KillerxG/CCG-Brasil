...
function s.cfilter(c,e,tp)
	return c:IsSetCard(0x297) and c:GetLevel()>0 and c:IsAbleToGraveAsCost()
...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc and Duel.SpecialSummon(sc,SUMMON_TYPE_XYZ,tp,tp,false,false,POS_FACEUP)>0 and sc:IsSetCard(0x297) then
		Duel.BreakEffect()
		c:CancelToGrave()
		Duel.Overlay(sc,c)
