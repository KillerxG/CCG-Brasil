...
function s.initial_effect(c)
	...
	Xyz.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x353),5,2,nil,nil,Xyz.InfiniteMats)
	...
	--(2)Can make 2 attacks on monsters
...
function s.atkcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return d~=nil and d:IsFaceup() and ((a:GetControler()==tp and a:IsSetCard(0x353) and a:IsRelateToBattle())
		or (d:GetControler()==tp and d:IsSetCard(0x353) and d:IsRelateToBattle()))
end
...
function s.xyzfilter(c,e,tp)
  return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x353) and c:IsRank(7) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_XYZ,tp,false,false)
end
