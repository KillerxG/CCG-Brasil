...
function s.initial_effect(c)	
	...
	e2:SetCondition(function(e) local c=e:GetHandler() return Duel.GetAttacker()==c or Duel.GetAttackTarget()==c end)
	e2:SetValue(1)
	c:RegisterEffect(e2)
	--(3)Banish battled monster
