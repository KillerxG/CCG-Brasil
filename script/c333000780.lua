...
function s.initial_effect(c)	
	--Fusion Procedure
	c:EnableReviveLimit()
	Fusion.AddProcMixN(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,0x261),1,s.ffilter,2)
...
--Fusion Procedure
function s.ffilter(c,fc,sumtype,sump)
	return c:IsAttribute(ATTRIBUTE_DARK,fc,sumtype,sump) and c:IsRace(RACE_THUNDER,fc,sumtype,sump)
end
