...
-- Filtro para identificar as cartas Shinigami (0x304) e Idrakian (0x313)
function s.restrict_filter(c)
    return c:IsSetCard(0x304) or c:IsSetCard(0x313)
end
...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
    ...
    -- "If you do not have a "Shinigami" or "Idrakian" card in your hand, field, GY or banishment:"
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
    ...
    -- SUBSTITUA ESSES NÚMEROS PELOS IDs DAS SUAS 20 CARTAS Shinigami
    local main_deck_ids = {
        777001470, 777001470, 777001990, 777001990, 777001990,
        777002970, 777002970, 777001660, 777001660, 777001660,
        777001830, 777001830, 777001830, 777002950, 777002950,
        777002950, 777002140, 777001120, 777001650, 777002120
    }
    ...
    if Duel.SendtoGrave(hand, REASON_EFFECT) > 0 then
        ...
        -- "...then add 20 "Shinigami" cards outside of the Duel to your Deck"
